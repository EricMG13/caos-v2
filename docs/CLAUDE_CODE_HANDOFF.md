...
| [#361](https://github.com/EricMG13/caos-v2/pull/361) | Delivery handoff row for the deterministic CP-DR fixture PR; source branch `deploy/handoff-359`, PR head `ab410d4` | `2a635c2` | 0/800 counted; 1 addition, 0 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 0.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |

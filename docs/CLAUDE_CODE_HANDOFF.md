...
| [#358](https://github.com/EricMG13/caos-v2/pull/358) | Binds pinned research briefs into CP-DR invocations; PR head `48fcd7f` | `1dde260` | 625/800 counted; 665 additions, 40 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 86.4% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
| [#363](https://github.com/EricMG13/caos-v2/pull/363) | Enables the LITE deep-research route with its pinned brief authority and route-set coverage; PR head `c657263` | `737c81a` | 653/800 counted; 657 additions, 4 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 0.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
| [#364](https://github.com/EricMG13/caos-v2/pull/364) | Adds the deterministic VMO2 deep-research qualification set and reconciled register fixtures; PR head `2b013d9` | `b591b02` | 457/800 counted; 506 additions, 49 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 100.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
| [#365](https://github.com/EricMG13/caos-v2/pull/365) | Pins the deep-research qualification digest fixture; PR head `1b5587d` | `7310ecb` | 0/800 counted; 3 additions, 3 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 0.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |

...
| [#367](https://github.com/EricMG13/caos-v2/pull/367) | Preserves quoted text inside Markdown spans; PR head `c0e1270` | `d6db949` | 3/800 counted; 6 additions, 3 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 100.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
| [#369](https://github.com/EricMG13/caos-v2/pull/369) | Delivers CP-DR authority from its contract; PR head `012ec59` | `b405aa1` | 178/800 counted; 179 additions, 1 deletion | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 100.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
| [#370](https://github.com/EricMG13/caos-v2/pull/370) | Records evidence delivery mode for every source merge; PR head `3473d2e` | `a5da36c` | 24/800 counted; 29 additions, 5 deletions | The same nine required checks all passed; SonarCloud reported zero new issues, security hotspots, or dependency risks, 0.0% new-code coverage and 0.0% duplication; `provider` and `smoke` skipped by workflow policy |
